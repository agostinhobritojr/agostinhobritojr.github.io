...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<faraday>.freeze, ["~> 2.7.10"])
  s.add_runtime_dependency(%q<faraday-rack>.freeze, ["~> 2"])
  s.add_runtime_dependency(%q<travis-gh>.freeze, ["~> 0.21.0"])
  s.add_runtime_dependency(%q<highline>.freeze, ["~> 2.1.0"])
  s.add_runtime_dependency(%q<json_pure>.freeze, ["~> 2.6.3"])
  s.add_runtime_dependency(%q<launchy>.freeze, ["~> 2.5.2"])
  s.add_runtime_dependency(%q<pusher-client>.freeze, ["~> 0.6.2"])
  s.add_runtime_dependency(%q<rack-test>.freeze, ["~> 2.1.0"])
